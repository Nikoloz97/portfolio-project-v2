...
const Tutoring = (props) => {
  ...
  const tutorPeriods = [
    ...
    {
      title: "Tech Elevator (Tutoring Bootcamp)",
      ...
      cards: [
        {
          ...
          websiteLinkUrl: null,
          mediaCaption:
            "My bootcamp's curriculum involved 3 group tutoring projects. The last one involved a restaurant match-making system called Restaurant Tinder. It consists of the following tech stack: Vue.js, C#, and SQL",
        },
        {
  ...
  return (
    <div className={`Tutoring-Screen ${isDesktop ? "Desktop" : "Phone"}`}>
      <div className="Tutoring-Content">
        <div className="Tutoring-Headers-Container">
          <div className="Tutoring-Header">Tutoring</div>
          <div className="Tutoring-Subheader-One">
            {tutorPeriods[periodIndex].title}
          </div>
          <div className="Tutoring-Subheader-Two">
            {tutorPeriods[periodIndex].period}
          </div>
        </div>

        <div className="Tutoring-Cards-Buttons-Container">
          <div
            className={`Tutoring-Card-Button ${
          ...
          <div className="Tutoring-Card">
            <img
              src={tutorPeriods[periodIndex].cards[0].mediaUrl}
              className="Tutoring-Card-Image"
              alt={tutorPeriods[periodIndex].cards[0].mediaAltText}
            />
            <div className="Tutoring-Card-Header">
              {tutorPeriods[periodIndex].cards[0].header}
            </div>
            {tutorPeriods[periodIndex].cards[0].techStack ? (
              <div className="Tutoring-Card-Tech">
                {`Tech Stack: ${tutorPeriods[periodIndex].cards[0].techStack}`}
              </div>
            ) : (
              <div></div>
            )}
            <div className="Tutoring-Card-Text">
              {tutorPeriods[periodIndex].cards[0].mediaCaption}
            </div>
          </div>
          <div className="Tutoring-Card Even">
            <img
              src={tutorPeriods[periodIndex].cards[1].mediaUrl}
              className="Tutoring-Card-Image"
              alt={tutorPeriods[periodIndex].cards[1].mediaAltText}
            />
            <div className="Tutoring-Card-Header">
              {tutorPeriods[periodIndex].cards[1].header}
            </div>
            {tutorPeriods[periodIndex].cards[1].techStack ? (
              <div className="Tutoring-Card-Tech">
                {`Tech Stack: ${tutorPeriods[periodIndex].cards[1].techStack}`}
              </div>
            ) : (
              <div></div>
            )}
            <div className="Tutoring-Card-Text">
              {tutorPeriods[periodIndex].cards[1].mediaCaption}
            </div>
          </div>
          <div className="Tutoring-Card">
            {tutorPeriods[periodIndex].cards[2].websiteLinkUrl ? (
              <a
                href={tutorPeriods[periodIndex].cards[2].websiteLinkUrl}
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src={tutorPeriods[periodIndex].cards[2].mediaUrl}
                  className="Tutoring-Card-Image"
                  alt={tutorPeriods[periodIndex].cards[2].mediaAltText}
                />
              </a>
            ) : (
              <img
            ...
            <div className="Tutoring-Card-Header">
              {tutorPeriods[periodIndex].cards[2].header}
            </div>
            {tutorPeriods[periodIndex].cards[2].techStack ? (
              <div className="Tutoring-Card-Tech">
                {`Tech Stack: ${tutorPeriods[periodIndex].cards[2].techStack}`}
              </div>
            ) : (
              <div></div>
            )}
            <div className="Tutoring-Card-Text">
              {tutorPeriods[periodIndex].cards[2].mediaCaption}
            </div>
          </div>
          <div
            className={`Tutoring-Card-Button ${
              periodIndex === tutorPeriods.length - 1 ? "Disabled" : ""
            }`}
